...
const Upload: NextPage = () => {
  return (
    <div className="px-4 py-16">
      ...
      <button
        className="mt-5 w-full bg-orange-500 hover:bg-orange-600 text-white py-2 px-4 border boreder-transparent rounded-md shadow-sm text-sm font-medium focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 focus:outline-one">
        Upload product
      </button>
    </div>
  );
